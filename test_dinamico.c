...
void ejecutar_test_dinamico(int id_caso, int n, int T, int t[], int p[]) {
    printf("==================================================\n");
    printf("TEST DINAMICO CASO %d: n=%d, T=%d\n", id_caso, n, T);
    printf("==================================================\n");
...
int main() {
    ...
    ejecutar_test_dinamico(4, n4, T4, t4, p4);
    ...
    ejecutar_test_dinamico(5, n5, T5, t5, p5);
